...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in facmgr/protobuf/facmgr_pb2_grpc.py depends on'
...
def add_ServerManagerServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('factorio_server.ServerManager', rpc_method_handlers)
